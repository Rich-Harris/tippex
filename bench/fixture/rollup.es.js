/*
	Rollup.js v0.41.5
	Tue Mar 14 2017 14:19:25 GMT+0000 (GMT) - commit ae9eb5c81b1126ef183251c7e9eb02e9c8bbf800
...
import { lstatSync, mkdirSync, readFileSync, readdirSync, realpathSync, writeFile } from 'fs';
...
var CustomParser = (function (Parser$$1) {
	function CustomParser () {
		Parser$$1.apply(this, arguments);
	}

	if ( Parser$$1 ) CustomParser.__proto__ = Parser$$1;
	CustomParser.prototype = Object.create( Parser$$1 && Parser$$1.prototype );
	CustomParser.prototype.constructor = CustomParser;

	CustomParser.prototype.parseBlock = function parseBlock () {
		var this$1 = this;
		...
		node.body = [];
		return this.finishNode(node, "DummyBlockStatement");
	};
